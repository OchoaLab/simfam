...
Note, however, use of the newly-introduced functions `draw_geno_last_gen`, `kinship_last_gen`, and `admix_last_gen` to directly construct data for the last generation only, which also saves memory compared to the more general `draw_geno_fam`, `kinship_fam`, and `admix_fam` shown earlier.
