...
Note, however, use of the newly-introduced functions `draw_geno_last_gen` and `kinship_last_gen` to directly construct data for the last generation only, which also saves memory compared to the more general `draw_geno_fam` and `kinship_fam` shown earlier.
...
admix_proportions_G <- admix_proportions[ indexes_G, ] # last generation only
